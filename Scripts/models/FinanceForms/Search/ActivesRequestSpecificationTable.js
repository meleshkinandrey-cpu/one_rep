define(['knockout', 'jquery', 'ajax', 'models/Table/TableParts', 'dateTimeControl', 'comboBox'], function (ko, $, ajaxLib, tpLib, dtLib) {
    var module = {
        ViewModel: function ($regionTable) {
            ...
            self.OnSelectedRow = null;//set in ActivesRequestSpecificationFindForm.js
            self.OnDeselectedRow = null;//set in ActivesRequestSpecificationFindForm.js
            self.CheckRowSelection = null;//set in ActivesRequestSpecificationFindForm.js
            //
            var $operationsLoadedD = $.Deferred();
            self.searchPhraseObservable = ko.observable('');//set in ActivesRequestSpecificationFindForm.js
            self.searchFilterData = ko.observable({ //set in ActivesRequestSpecificationFindForm.js
                ProductCatalogID: null,
                ProductCatalogClassID: null,
                NumbersID: [],
                CustomersID: [],
                CustomerFilterClassID: null,
                CustomerFilterID: null,
                ReferenceID: [],
                DatePromise: null,
            });
            self.ShowFormFunc = null; //set in ActivesRequestSpecificationFindForm.js
            //
            ...
            //
            self.viewName = 'ActivesRequestSpecificationSearch';
            ...
            self.ShowForm = function (cell) {
                ...
                //               
                if (self.ShowFormFunc && cell.Row.ID)
                    self.ShowFormFunc(cell.Row.ID);
            };
            //
            ...
            self.Load = function () {
                ...
                var requestInfo = {
                    ...
                    ProductCatalogID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().ProductCatalogID : null,
                    ProductCatalogClassID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().ProductCatalogClassID : null,
                    NumbersID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().NumbersID : null,
                    CustomersID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().CustomersID : null,
                    CustomerFilterClassID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().CustomerFilterClassID : null,
                    CustomerFilterID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().CustomerFilterID : null,
                    ReferenceID: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().ReferenceID : null,
                    DatePromise: self.searchFilterData && self.searchFilterData() ? self.searchFilterData().DatePromise : null,
                ...
                self.ajaxControl.Ajax($regionTable,
                    {
                        ...
                        method: 'POST',
                        data: requestInfo,
                        url: 'finApi/GetARSSearchListForTable'
                    },
                    function (newVal) {
                        if (newVal && newVal.Result === 0) {
                            ...
                            require(['sweetAlert'], function () {
                                swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[ActivesRequestSpecificationTable.js Load]', 'error');
                            });
                        }
                ...
                self.ajaxControl.Ajax(null,
                    ...
                    function (newVal) {
                        if (newVal && newVal.Result === 0) {
                            ...
                            require(['sweetAlert'], function () {
                                swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[ActivesRequestSpecificationTable.js AppendOrUpdate]', 'error');
                            });
                        }
                        else if (newVal && newVal.Result === 2) {
                            require(['sweetAlert'], function () {
