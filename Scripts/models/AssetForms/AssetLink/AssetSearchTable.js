define(['knockout', 'jquery', 'ajax', 'models/Table/TableParts', 'dateTimeControl', 'comboBox'], function (ko, $, ajaxLib, tpLib, dtLib) {
    var module = {
        ViewModel: function ($regionTable) {
            ...
            self.OnSelectedRow = null;//set in AssetLink.js
            self.OnDeselectedRow = null;//set in AssetLink.js
            self.CheckRowSelection = null;//set in AssetLink.js
            //
            self.ShowListForEmptyQuery = true;//set in AssetLink.js
            //
            var $operationsLoadedD = $.Deferred();
            self.searchPhraseObservable = ko.observable('');//set in AssetLink.js
            self.searchFilterData = ko.observable({ //set in AssetLink.js
                TypeID: null,
                ModelsID: [],
                VendorsID: [],
                LocationClassID: null, //LocationClassID
                LocationID: null
            });
            //
            ...
            self.ShowForm = function (cell) {
                ...
                require(['assetForms'], function (module) {
                    ...
                    fh.ShowAssetForm(cell.Row.ID, cell.Row.ClassID);
                });
            };
            //
            ...
            self.Load = function () {
                ...
                var requestInfo = {
                    ...
                    ShowListForEmptyQuery: self.ShowListForEmptyQuery
                };
                self.ajaxControl.Ajax($regionTable,
                    {
                        ...
                        method: 'POST',
                        data: requestInfo,
                        url: 'imApi/GetAssetSearchListForTable'
                    },
                    function (newVal) {
                        if (newVal && newVal.Result === 0) {
                            ...
                            require(['sweetAlert'], function () {
                                swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[AssetSearchTable.js Load]', 'error');
                            });
                        }
                ...
                self.ajaxControl.Ajax(null,
                    ...
                    function (newVal) {
                        if (newVal && newVal.Result === 0) {
                            ...
                            require(['sweetAlert'], function () {
                                swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[AssetSearchTable.js AppendOrUpdate]', 'error');
                            });
                        }
                        else if (newVal && newVal.Result === 2) {
                            require(['sweetAlert'], function () {
