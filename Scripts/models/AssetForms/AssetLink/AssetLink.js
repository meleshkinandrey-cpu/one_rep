define(['knockout',
    ...
    function (ko,
        ...
        var module = {
            ...
            ParameterSelectorModel: function ($region, mainOnChangeSelected, mainCheckerAlreadySelected, showListForEmptyQuery, focusSearcher, showWrittenOff, uniqueAssetTypeToShow, NewHaspAdapterForm, ShowKE, IsConfigurationUnitAgentForm, ConfigurationUnitAgentTypeID, IsHostClusterForm, IsVMClusterForm, IsInventory) {
                var self = this;
                //
                ...
                {//events of listView
                    ...
                    self.getObjectList = function (startRecordIndex, countOfRecords, idArray, showErrors) {
                        ...
                        var requestInfo = {
                            ...
                            IsHostClusterForm: IsHostClusterForm ? IsHostClusterForm : false,
                            IsVMClusterForm: IsVMClusterForm ? IsVMClusterForm : false,
                            IsInventory: IsInventory ? IsInventory: false
                        };
                        //
