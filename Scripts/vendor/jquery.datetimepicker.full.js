...
; (function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['jquery', 'jqueryMouseWheel'], factory);
        ...
        createDateTimePicker = function (input) {
            ...
            mounth_picker
				...
				.on('touchend mousedown.xdsoft', function () {
				    ...
				    //
				    options.startDate = _xdsoft_datetime.setCurrentTime(0);//hack Alex
            ...
            setPos = function () {
                ...
                if (options.fixed) {
                    ...
                    forEachAncestorOf(dateInputElem, function (ancestorNode) {
                        if (ancestorNode && window.getComputedStyle(ancestorNode).getPropertyValue('position') === 'fixed') {
